...
/// @title GroodV3 — variable-stake native-ETH pari-mutuel 5x5 grid on Robinhood Chain
...
///         wherever it sits. No bonus rounds, no reward token — the pot is
///         the whole game. UUPS-upgradeable (storage layout frozen from V2:
///         retired variables are retained but unused).
contract GroodV3 is Initializable, Ownable2StepUpgradeable, UUPSUpgradeable {
